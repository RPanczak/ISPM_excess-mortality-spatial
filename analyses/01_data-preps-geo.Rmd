...
library(pacman)
p_load(sf, tidyverse, magrittr, scales)
...
write_rds(bz21, "data/BfS/bz21.fst")
write_rds(kt21, "data/BfS/kt21.fst")
write_rds(se21, "data/BfS/se21.fst")
```
...
# write_rds(st_bz21, "data/swisstopo/st_bz21.fst")
write_rds(st_kt21, "data/swisstopo/st_kt21.fst")
```
...
```{r}
write_rds(gg21, "data/BfS/gg21.fst")
write_rds(st_gg21, "data/swisstopo/st_gg21.fst")
```

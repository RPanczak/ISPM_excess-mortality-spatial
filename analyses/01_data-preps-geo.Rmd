...
Additionally datasets differ in terms of conceptualization of the boundaries of water bodies. BfS data reach the shore of the lake, whereas swisstopo extends them over lakes. Example of municipality Delley-Portalban by the Lake Neuchâtel:  
...
BfS stores data as `MULTIPOLYGON`. In such case municipality split over several disconetcted areas is stored as *single record*. Example of municipality Monthey which consists of four separate areas:  

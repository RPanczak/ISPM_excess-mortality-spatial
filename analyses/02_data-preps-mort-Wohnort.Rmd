...
Using **Wohnort** (the community where the person died) as unit of analysis.   
...
`r number(sum(w_deaths_2015_2021$COUNT), big.mark = ",")` deaths by year:  
...
There were `r number(nrow(raum), big.mark = ",")` communities in Jul 2021 in CH.  
...
That obviously increases the size of the dataset from `r number(nrow(w_deaths_2015_2021), big.mark = ",")` to `r number(nrow(w_deaths_2015_2021_exp), big.mark = ",")` (*ie.* 2,163 communities each with 2,016 data points * 7 years * 12 months * 6 age groups * 2 sexes * 2 nationality cats).  

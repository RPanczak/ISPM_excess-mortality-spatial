...
pagetitle: "Spatial Excess: mortality data"
...
```{r include=FALSE}
# write_rds(w_deaths_2015_2021, "data/BfS-closed/monthly_deaths/w_deaths_2015_2021.Rds")
write_rds(w_deaths_2015_2021_exp, "data/BfS-closed/monthly_deaths/w_deaths_2015_2021_exp.Rds")
```
...
That reduces the size of the dataset to `r number(nrow(w_deaths_2015_2021_ar), big.mark = ",")` rows.  
...
```{r include=FALSE}
write_rds(w_deaths_2015_2021_ar, "data/BfS/monthly_deaths/w_deaths_2015_2021_ar.Rds")
```

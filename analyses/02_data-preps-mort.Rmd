...
library(pacman)
p_load(sf, tidyverse, magrittr, janitor, scales, lubridate, kableExtra)
...
That obviously increases the size of the dataset from `r number(nrow(deaths_2015_2021), big.mark = ",")` to `r number(nrow(deaths_2015_2021_exp), big.mark = ",")` (*ie.* 2,163 communities each with 2,016 data points).  
...
```{r include=FALSE}
write_rds(deaths_2015_2021, "data/BfS-closed/deaths_2015_2021.Rds")
write_rds(deaths_2015_2021_exp, "data/BfS-closed/deaths_2015_2021_exp.Rds")
```
...
```{r include=FALSE}
write_rds(deaths_2015_2021_bez, "data/BfS-closed/deaths_2015_2021_bez.Rds")
```

## Aggregating to Arbeitsmarktgrossregionen 

```{r}
deaths_2015_2021_ar <- deaths_2015_2021_exp %>% 
...
That reduces the size of the dataset to `r number(nrow(deaths_2015_2021_ar), big.mark = ",")`.  

Proportion of zero cells:

```{r echo=FALSE}
frq(deaths_2015_2021_ar, deaths == 0)
```
...
```{r include=FALSE}
write_rds(deaths_2015_2021_ar, "data/BfS-closed/deaths_2015_2021_ar.Rds")
```
...
For each age, sex, nationality stratum, for each municipality separately, poisson model is fit using the 2014-2019 data; then prediction is made for 2020 & 2021 years. The gist of this operation is to exclude the effect of pandemic from the population counts in years affected.   

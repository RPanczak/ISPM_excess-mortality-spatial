...
Communitu mutations data after `2021-01-01` from Cordula are integrated into the data and pops are recalculated using these new codes to match mortality.  
...
deaths_2015_2021_exp %<>% 
  ...
  # nonexistent strata should mean 0 pops

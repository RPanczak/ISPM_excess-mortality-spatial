...
```{r echo=FALSE}
frq(population_ext_lm, population_ext_lm < 0)
```

### Poisson model

Similar as above but this time with Poisson model:  
...
w_deaths_2015_2021_ar_pop <- read_rds("data/BfS/monthly_deaths/w_deaths_2015_2021_ar.Rds") %>% 

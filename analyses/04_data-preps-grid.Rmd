...
STATPOP data, state of 31st Dec each year.
...
gc()
r20_pe_grid = geom_001_pe_to_grid("data/BfS-closed/STATPOP/r20_pe.dta")
write_rds(r20_pe_grid, "data/BfS-closed/STATPOP/r20_pe_grid.Rds")
rm(r20_pe_grid); gc()

gc()
r19_pe_grid = geom_001_pe_to_grid("data/BfS-closed/STATPOP/r19_pe.dta")
write_rds(r19_pe_grid, "data/BfS-closed/STATPOP/r19_pe_grid.Rds")
rm(r19_pe_grid); gc()

gc()
r18_pe_grid = geom_001_pe_to_grid("data/BfS-closed/STATPOP/r18_pe.dta")
write_rds(r18_pe_grid, "data/BfS-closed/STATPOP/r18_pe_grid.Rds")
rm(r18_pe_grid); gc()

gc()
r17_pe_grid = geom_001_pe_to_grid("data/BfS-closed/STATPOP/r17_pe.dta")
write_rds(r17_pe_grid, "data/BfS-closed/STATPOP/r17_pe_grid.Rds")
rm(r17_pe_grid); gc()

gc()
r16_pe_grid = geom_001_pe_to_grid("data/BfS-closed/STATPOP/r16_pe.dta")
write_rds(r16_pe_grid, "data/BfS-closed/STATPOP/r16_pe_grid.Rds")
rm(r16_pe_grid); gc()

gc()
r15_pe_grid = geom_001_pe_to_grid("data/BfS-closed/STATPOP/r15_pe.dta")
write_rds(r15_pe_grid, "data/BfS-closed/STATPOP/r15_pe_grid.Rds")
rm(r15_pe_grid); gc()

gc()
r14_pe_grid = geom_001_pe_to_grid("data/BfS-closed/STATPOP/r14_pe.dta")
write_rds(r14_pe_grid, "data/BfS-closed/STATPOP/r14_pe_grid.Rds")
rm(r14_pe_grid); gc()
```

```{r}
pe_grid = bind_rows(read_rds("data/BfS-closed/STATPOP/r20_pe_grid.Rds") %>% 
                      st_drop_geometry(),
